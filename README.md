...
| 메인 화면 | 에이전트 동작 과정 |
|:---------:|:-----------------:|
| ![메인화면](writer1.webp) | ![에이전트](writer2.webp) |

**4컷 만화 생성 결과**

| 장면 1 · 2 | 장면 3 · 4 |
|:----------:|:-----------:|
| ![1-2컷](writer3.webp) | ![3-4컷](writer4.webp) |

> 입력 예시: *"오늘은 유치원 놀이터에서 커다란 모래성을 쌓았다. 나뭇가지로 깃발도 꽂고 조개껍데기로 예쁜 성문을 만들었다. 갑자기 길고양이가 다가와서 쿵쿵거리더니 우리 성 옆에서 낮잠을 잤다. 성을 지키는 기사가 된 것 같아 뿌듯하고 즐거운 하루였다."*
...
```
a-little-writer/
├── writer1.webp         # 스크린샷 - 메인 화면
├── writer2.webp         # 스크린샷 - 에이전트 동작
├── writer3.webp         # 스크린샷 - 1·2컷 결과
├── writer4.webp         # 스크린샷 - 3·4컷 결과
